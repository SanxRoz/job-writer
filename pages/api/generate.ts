...
const handler = async (req: Request): Promise<Response> => {
  ...
  const payload: OpenAIStreamPayload = {
    ...
    messages: [
      {
        role: "system",
        content: `You are a world class job writer, return me the text on markdown and between each section add a 2 breaklines on markdown, on sections Tasks and responsibilities, Skills and experience and Benefits and perks return me a list, Don't use the symbol '$', in any case
